...
Model_path = os.path.join(set_up.PJ_path, '../Models/Qwen-7B-Chat')
...
set_up.logger_main.debug('Model_Q7-chat has been loaded.')
set_up.logger_acu.debug('Model_Q7-chat has been loaded.')
