...
Model_path = os.path.join(set_up.PJ_path, '../Models/Qwen-14B')
...
set_up.logger_main.debug('Model_Q14 has been loaded.')
set_up.logger_acu.debug('Model_Q14 has been loaded.')
