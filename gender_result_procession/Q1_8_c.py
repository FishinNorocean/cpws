# Qwen-1_8B-chat Model Processer
...
Model_path = os.path.join(set_up.PJ_path, '../Models/Qwen-1_8B-Chat')
...
set_up.logger_main.debug('Model_Q1_8-chat has been loaded.')
set_up.logger_acu.debug('Model_Q1_8-chat has been loaded.')
